    ...
    <div style="page-break-before: always;">
        ...
        <ol>
            <li><strong>Definitions</strong>
                <p>In this Agreement, unless the context otherwise requires, the following expressions have the following meanings:</p>
                <ul>
                    <li>"Landlord" means the owner of the Property</li>
                    <li>"Tenant" means the person(s) renting the Property</li>
                    <li>"Property" means the premises described in this Agreement</li>
                </ul>
            </li>
            
            <li><strong>Term of Tenancy</strong>
                <p>The tenancy shall commence on {{ $contract->start_date }} and continue until {{ $contract->end_date }}.</p>
            </li>
            
            <li><strong>Rent Payment</strong>
                <p>Rent shall be paid monthly in advance on the first day of each month.</p>
            </li>
            
            <li><strong>Security Deposit</strong>
                <p>A security deposit of ${{ number_format($contract->security_deposit, 2) }} shall be held by the Landlord.</p>
            </li>
            
            <li><strong>Maintenance and Repairs</strong>
                <p>The Tenant shall maintain the Property in good condition and promptly report any necessary repairs.</p>
            </li>
            
            <li><strong>Utilities</strong>
                <p>The Tenant shall be responsible for all utility charges unless otherwise specified.</p>
            </li>
            
            <li><strong>Termination</strong>
                <p>Either party may terminate this Agreement by giving {{ $contract->notice_period }} days written notice.</p>
            </li>
